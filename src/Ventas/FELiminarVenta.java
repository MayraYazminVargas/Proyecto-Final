...
public class FELiminarVenta extends javax.swing.JDialog {
     ...
     */
    public FELiminarVenta(String id,AdminVentasCompras acv) {       
        this.acv=acv;
        modoConsulta = true;                                
        initComponents();  
        initMYComponents();
    ...
    public FELiminarVenta(AdminVentasCompras acv,java.awt.Frame parent, boolean md) {        
        super(parent, md);    
        this.acv=acv;
        modoConsulta = false;
        initComponents();  
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eliminar Ventas");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Eliminar Venta"));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        int reply = JOptionPane.showConfirmDialog(null
                , "¿Esta seguro que desea eliminar la informacion de venta?"
