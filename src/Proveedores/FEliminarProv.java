...
public class FEliminarProv extends javax.swing.JFrame {

    Validar v = new Validar();
    AdministrarProveedores ap;
    String idd;

    public FEliminarProv(AdministrarProveedores ap) {
        this.ap = ap;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Eliminar Proveedor"));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        JOptionPane.showMessageDialog(null, "Proveedor con id a eliminar: " + idd + " de nombre: " + txtNombre.getText());
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            txtContacto.setText("");
            txtRFC.setText("");
            JOptionPane.showMessageDialog(null, "Proveedor Eliminado","Operacion Exitosa",1);
        }
