...
public class FConsIndCompras extends javax.swing.JDialog {
    ...
    public FConsIndCompras(String id,AdminVentasCompras acv) {       
        this.acv=acv;
        modoConsulta = true;                                
        initComponents();  
        initMYComponents();
    ...
    public FConsIndCompras(AdminVentasCompras acv,java.awt.Frame parent, boolean md) {        
        super(parent, md);    
        this.acv=acv; 
        modoConsulta = false;
        initComponents();  
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Consulta Individual Compras"));
